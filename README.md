...
This is Team 146's group project GitHub repository for CSE 6242 (Canvas) Spring of 2026 semester.
...
## ***Directory Structure:***
### Model Building
1. [Data](https://github.gatech.edu/CSE6242_Project/tree/main/Data) - *the building blocks of our empire!*
2. [Code](https://github.gatech.edu/CSE6242_Project/tree/main/Code) - *where the magic happens!*
3. [Visualizations](https://github.gatech.edu/CSE6242_Project/tree/main/Visualizations) - *the home of all our pretty graphs.*


### Reporting:
1. [Project Proposal](https://github.gatech.edu/CSE6242_Project/tree/main/Project%20Proposal) - *where the silly idea started.*
2. [Proposal Video](https://github.gatech.edu/CSE6242_Project/tree/main/Proposal%20Presentation) - *where we first spoke about the silly idea.* 
3. [Progress Report](https://github.gatech.edu/CSE6242_Project/tree/main/Progress%20Report) - *when we realized what we had got ourselves into.*
4. [Final Report](https://github.gatech.edu/CSE6242_Project/tree/main/Final%20Report) - *We cried, worked, cried some more, worked again, on repeat.*
5. [Final Video](https://github.gatech.edu/CSE6242_Project/tree/main/Final%20Presentation%20Slides) - *The light at the end of the tunnel*
